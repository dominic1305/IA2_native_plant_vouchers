		...
		if (isset($_POST["data-send"])) {
			...
			switch ($data->cmd) {
				...
				case "query_data": {//returns the result of a SQL query TODO: implement server integration
					$query = $data->data;
					#region
					$vouchers = [["address","pref_contact","email","phone_number","rate_number","plant_1","plant_2","placement_time"],["29 street street","phone","email@email.com",238193831,2132141241,0,8,1715229017962],["31 street avenue","email","mailE@email.com",6537684193,8986943729,15,23,1715229084806]];
